...
export class PublicEstateController {
    ...
    @Get(':estateId/apartment-types')
    @ApiOperation({ summary: 'Get active estate apartment types by estate ID' })
    getEstateApartmentTypes(@Param('estateId') estateId: string) {
        return this.estateConfigService.getPublicEstateApartmentTypes(estateId);
    }
}
...
export class AdminEstateConfigController {
    ...
    updateEstateDetails(
        ...
        @Body() dto: UpdateEstateDetailsDto,
    ) {
    ...
    updateSettings(
        @CurrentUser() user: any,
        @Body() dto: UpdateEstateSettingsDto,
    ) {
    ...
    createApartmentType(
        ...
        return this.estateConfigService.createApartmentType(user.id, dto);
    }

    @Get('apartment-types')
    @ApiOperation({ summary: 'Get estate apartment types' })
    getApartmentTypes(@CurrentUser() user: any) {
        return this.estateConfigService.getApartmentTypes(user.id);
    }

    @Get('apartment-types/:apartmentTypeId')
    @ApiOperation({ summary: 'Get apartment type' })
    getApartmentType(
        @CurrentUser() user: any,
        @Param('apartmentTypeId') apartmentTypeId: string,
    ) {
        return this.estateConfigService.getApartmentType(
            user.id,
            apartmentTypeId,
        );
    }

    @Patch('apartment-types/:apartmentTypeId')
    @Roles(Role.SUPER_ADMIN)
    @ApiOperation({ summary: 'Update apartment type' })
    updateApartmentType(
        @CurrentUser() user: any,
        @Param('apartmentTypeId') apartmentTypeId: string,
        @Body() dto: UpdateApartmentTypeDto,
    ) {
        return this.estateConfigService.updateApartmentType(
            user.id,
            apartmentTypeId,
            dto,
        );
    ...
    @Delete('apartment-types/:apartmentTypeId')
    @Roles(Role.SUPER_ADMIN)
    @ApiOperation({ summary: 'Delete or deactivate apartment type' })
    deleteApartmentType(
        @CurrentUser() user: any,
        @Param('apartmentTypeId') apartmentTypeId: string,
    ) {
        return this.estateConfigService.deleteApartmentType(
            user.id,
            apartmentTypeId,
        );
    }
    ...
    createHeavyVehicleCategory(
        ...
        return this.estateConfigService.createHeavyVehicleCategory(
            user.id,
            dto,
        );
    }
    ...
    updateHeavyVehicleCategory(
        ...
        return this.estateConfigService.updateHeavyVehicleCategory(
            user.id,
            categoryId,
            dto,
        );
    ...
    deleteHeavyVehicleCategory(
        @CurrentUser() user: any,
        @Param('categoryId') categoryId: string,
    ) {
        return this.estateConfigService.deleteHeavyVehicleCategory(
            user.id,
            categoryId,
        );
    }
